...
class PlaceImage extends DataClass implements Insertable<PlaceImage> {
  ...
  /// URL изображения
  final String url;
  PlaceImage({required this.placeId, required this.url});
  ...
  PlaceImage copyWith({int? placeId, String? url}) => PlaceImage(
  ...
  @override
  int get hashCode => Object.hash(placeId, url);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is PlaceImage &&
...
class PlaceImagesCompanion extends UpdateCompanion<PlaceImage> {
  ...
  PlaceImagesCompanion copyWith({Value<int>? placeId, Value<String>? url}) {
    return PlaceImagesCompanion(
      placeId: placeId ?? this.placeId,
      url: url ?? this.url,
    );
...
class $PlaceImagesTable extends PlaceImages
  ...
  late final GeneratedColumn<int?> placeId = GeneratedColumn<int?>(
      ...
      type: const IntType(),
      requiredDuringInsert: true,
      defaultConstraints: 'REFERENCES favorite_places (id) ON DELETE CASCADE');
  ...
  late final GeneratedColumn<String?> url = GeneratedColumn<String?>(
      ...
      type: const StringType(), requiredDuringInsert: true);
  @override
  List<GeneratedColumn> get $columns => [placeId, url];
  @override
...
abstract class _$PlacesDatabase extends GeneratedDatabase {
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [searchHistoryRequests, favoritePlaces, placeImages];
}
