...
const List<Sight> sightsMock = [
  Sight(
    name: 'Астраханский кремль',
    point: LocationPoint(lat: 46.34916573351107, lon: 48.03225584602448),
    url:
    ...
    category: ParticularPlaceSightCategory(),
  ),
  Sight(
    name: 'Памятник Петру I',
    point: LocationPoint(lat: 46.347543009464154, lon: 48.0161004460226),
  ...
  Sight(
    ...
    point: LocationPoint(lat: 46.35408370923373, lon: 48.02939603968672),
    url:
  ...
  Sight(
    ...
    point: LocationPoint(lat: 46.35274991858566, lon: 48.02711255213182),
    url:
  ...
  Sight(
    ...
    point: LocationPoint(lat: 46.360495591636514, lon: 48.044221555826134),
    ...
    category: MuseumSightCategory(),
  ),
  Sight(
    name: 'Усадьба М. А. Шелехова',
    point: LocationPoint(lat: 46.35303348430326, lon: 48.04749808281461),
    url:
  ...
  Sight(
    ...
    point: LocationPoint(lat: 46.35500666438446, lon: 48.04372892883719),
  ...
  Sight(
    ...
    point: LocationPoint(lat: 46.343267805146695, lon: 48.02028376932002),
    url:
    ...
    category: ParkSightCategory(),
  ),
];

const List<CategoryFilterEntity> categoryFiltersMock = [
  HotelCategoryFilterEntity(),
