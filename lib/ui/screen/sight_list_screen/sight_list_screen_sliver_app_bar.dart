...
class SightListScreenSliverAppBar extends StatefulWidget {
  final ScrollController scrollController;

  const SightListScreenSliverAppBar({
    required this.scrollController,
    Key? key,
  }) : super(key: key);

  @override
  State<SightListScreenSliverAppBar> createState() =>
      _SightListScreenSliverAppBarState();
}

class _SightListScreenSliverAppBarState
    extends State<SightListScreenSliverAppBar> {
                  ...
                  child: Stack(
                    ...
                    children: [
                      Positioned(
                        ...
                        left: 0,
                        child: Text(
                          AppStrings.sightListAppBarFirstLineTitle,
                      ...
                      Positioned(
                        ...
                        right: 0,
                        child: Text(
                          AppStrings.sightListAppBarSecondLineTitle,
                          style: AppTypography.subtitleBoldTextStyle.copyWith(
                            color: colorScheme.primary,
                          ),
                        ),
